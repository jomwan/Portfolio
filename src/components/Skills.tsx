...
export default function Skills() {
  ...
  const expertise = [
    {
      title: t.skills.cards[0]?.label || "Full-Stack Web",
      desc: t.skills.cards[0]?.desc || "Modern and interactive front-end and back-end ecosystems.",
      icon: Layout,
    ...
    {
      title: t.skills.cards[1]?.label || "Languages",
      desc: t.skills.cards[1]?.desc || "Proficient across standard application development languages.",
      icon: Terminal,
    ...
    },
    {
      ...
      icon: BrainCircuit,
      skills: ["Agent Modeling", "Pandas", "ML Pipelines", "Numpy"],
